...
const LinkedList: React.FC = () => {
  return (
    <div className="overflow-x-hidden max-w-[90%] xl:max-w-[80%] mx-auto mb-24">
      <h1 className="heading1 mt-10 text-center">Linked List</h1>
      <h3 className="heading2 mt-4 mb-2 sm:mt-6 sm:mb-3">What is an linked List</h3>
      <p className="paragraph sm:mb-10 sm:leading-10">{linkedlistData.definition}</p>
      <img
        ...
        alt="arrayImage"
      />
      <p className="paragraph sm:mt-10 sm:leading-10">{linkedlistData.explanation}</p>
      ...
      <h3 className="heading2 mt-4 mb-2 sm:mt-10 sm:mb-3">
        Important Coding Problems on Linked List
      </h3>
      {linkedlistData.questions.map((question) =>(
