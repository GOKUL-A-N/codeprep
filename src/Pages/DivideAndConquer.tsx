...
import { divideAndConquerData } from '../constants/divideAndConquerData'

const DivideAndConquer:React.FC = () => {
  return (
    <div className="overflow-x-hidden max-w-[90%] xl:max-w-[80%] mx-auto mb-24">
      <h1 className="heading1 mt-10 text-center">Divide And Conquer</h1>
      <h3 className="heading2 mt-4 mb-2 sm:mt-6 sm:mb-3">What is an Divide And Conquer</h3>
      <p className="paragraph sm:mb-10 sm:leading-10">{divideAndConquerData.definition}</p>
      <img
        className="hidden sm:block h-[25rem] md:h-[35rem] w-full"
        src="https://www.geeksforgeeks.org/wp-content/uploads/Merge-Sort-Tutorial.png"
        alt="arrayImage"
      />
      ...
      {divideAndConquerData.questions.map((question) =>(
