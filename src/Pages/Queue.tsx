...
import { queueData } from '../constants/queue'

const Queue: React.FC = () => {
  return (
    <div className="overflow-x-hidden max-w-[90%] xl:max-w-[80%] mx-auto mb-24">
      <h1 className="heading1 mt-10 text-center">Queue</h1>
      <h3 className="heading2 mt-4 mb-2 sm:mt-6 sm:mb-3">What is an Queue</h3>
      <p className="paragraph sm:mb-10 sm:leading-10">{queueData.definition}</p>
      <img
      ...
      <h3 className="heading2 mt-4 mb-2 sm:mt-10 sm:mb-3">
        Important Coding Problems on QUeue
      </h3>
      {queueData.questions.map((question) =>(
