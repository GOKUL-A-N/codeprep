  ...
  return (
    <div id="datastructures">
      ...
      <div className="rounded flex justify-around flex-wrap">
        <DataStructureComponent name="Arrays" />
        <DataStructureComponent name="LinkedList" />
        <DataStructureComponent name="Strings" />
        <DataStructureComponent name="Stack" />
        <DataStructureComponent name="Queue" />
        <DataStructureComponent name="Bit Manipulation" />
        <DataStructureComponent name="Math" />
        <DataStructureComponent name="Trees" />
      </div>
    </div>
  );
};
